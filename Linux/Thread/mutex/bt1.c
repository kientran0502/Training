...
void *producer1(void *arg)
{
    while(1)
    {
        ...
        printf("Producer 1 produced an item\n");
        usleep(500000);
    }
}
...
void *producer2(void *arg)
{
    while(1)
    {
        sem_wait(&bracket_empty_slots);
        sem_post(&bracket_used_slots);
        printf("Producer 2 produced an item\n");
        usleep(500000);
    }
}
...
void *consumer1(void *arg)
{
    while(1)
    {
        ...
        printf("Consumer 1 consumed an item\n");
        usleep(700000);
    }
}
...
void *consumer2(void *arg)
{
    while(1)
    {
        sem_wait(&bracket_used_slots);
        sem_post(&bracket_empty_slots);
        printf("Consumer 2 consumed an item\n");
        usleep(700000);
    }
}
...
void *consumer3(void *arg)
{
    while(1)
    {
        sem_wait(&bracket_used_slots);
        sem_post(&bracket_empty_slots);
        printf("Consumer 3 consumed an item\n");
        usleep(700000);
    }
}
